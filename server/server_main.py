import os
from aes_gcm_decrypt import decrypt
from server_rsa_key_exchange import decrypt_key
...
# Decrypt AES key
aes_key = decrypt_key(enc_key)

# Decrypt file
plaintext = decrypt(aes_key, nonce, tag, ciphertext)

# Verify signature
client_pub = os.path.join(KEYS_DIR, "client_public.pem")
verify(plaintext, signature, client_pub)
