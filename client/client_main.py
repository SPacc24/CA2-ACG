import sys
import os
from acg_gcm_encrypt import encrypt
from rsa_key_exchange import encrypt_key
...
aes_key, nonce, ciphertext, tag = encrypt(data)

enc_key = encrypt_key(aes_key, "server_public.pem")
signature = sign(data, os.path.join(BASE_DIR, "..", "keys", "client_private.pem"))
